...
position:relative;  color: red;font-weight:bold; margin-left:10px;font-size:25px;
 ...
 <div class="container-fluid">
  ...
  <button type="submit" id="but" class="btn btn-success" name="login">Sign In</button>
  <div style="color:red; text-align:center" id=error>${errorMessage1}</div>
  <p id="mem">Not a member?<a href="Register.jsp"> Sign Up</a></p>
</form>
</div>
 </body>
</html>